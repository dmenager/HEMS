         ...
         (loop
           ...
           do
              ...
              (let (merged)
                ...
                (return merged))))
        (t
         (when t (and (equal "OBSERVATION_VAR2_210" (rule-based-cpd-dependent-id phi2)))
      ...
      collect i into unmatched
       ...
       (return
         (loop
	      ...
	      (when t
		(format t "~%~%dummy match:~%~S~%rules for dummy match:~%~S" dummy-match rules))
	      (loop
